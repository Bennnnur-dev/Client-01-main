...
function generateContainers(){
    ...
    services.forEach((service, index) => {
        if (index === 0) {spreadingDirection = -7; zIndex = 20; size = 0.9} // Technical Management
        if (index === 1) {spreadingDirection = -4; zIndex = 25; size = 0.95} // Project Management
        if (index === 2) {spreadingDirection = 0; zIndex = 30; size = 1} // Management Services
        if (index === 3) {spreadingDirection = 4; zIndex = 25; size = 0.95} // Recruitment Service
        if (index === 4) {spreadingDirection = 7; zIndex = 20; size = 0.9} // Audit Service
